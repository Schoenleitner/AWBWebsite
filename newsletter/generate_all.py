...
WEISSENKIRCHEN = [
    ...
    (22, "Die ersten Familien sind eingezogen.",
     "In Weißenkirchen ist Leben eingekehrt — die ersten Familien wohnen schon hier.",
     "Freitag, Woche 11",
     "Leben zieht ein.",
     ["In Weißenkirchen ist Leben eingekehrt: Die ersten Familien sind bereits eingezogen — weitere ziehen gerade ein.",
      "Wir freuen uns mit ihnen — und auf alle, die diesen Schritt noch vor sich haben.",
      "Noch sind Häuser verfügbar. Vielleicht wird eines davon schon bald Ihr Zuhause.",
