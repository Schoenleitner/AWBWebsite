...
WEISSENKIRCHEN = [
    ...
    (10, "Ihr Kaufpreis steht — was auch immer kommt.",
     ...
     ["Immobilienpreise steigen, Zinsen schwanken, Baukosten entwickeln sich unvorhersehbar. Wer heute wartet, zahlt morgen oft mehr — das haben die vergangenen Jahre deutlich gezeigt.",
      ...
      "Das ist kein Werbeversprechen, sondern eine vertraglich garantierte Festpreiszusage. Je nach Preisentwicklung kann sich daraus ein erheblicher finanzieller Vorteil ergeben.",
