...
WEISSENKIRCHEN = [
    ...
    (10, "Ihr Kaufpreis steht — was auch immer kommt.",
     ...
     ["Immobilienpreise steigen. Zinsen schwanken. Baukosten explodieren. Wer heute noch wartet, zahlt morgen mehr — das zeigen die letzten Jahre deutlich.",
      "Unser Mietkauf dreht diesen Spieß um: Sie schreiben sich Ihren Kaufpreis heute fest. Vertraglich. Was auch immer in den nächsten Jahren passiert — Ihr Preis bleibt Ihr Preis.",
      "Das ist kein Marketing-Versprechen. Das ist eine vertragliche Garantie. Und sie kann, je nach Marktentwicklung, einen erheblichen finanziellen Vorteil bedeuten.",
      "Wer sofort kaufen möchte, hat natürlich auch diese Möglichkeit — ebenfalls zum Festpreis. Keine Nachforderungen. Kein Kleingedrucktes."],
    ...
    (12, "So funktioniert unser Mietkauf — und warum er anders ist.",
     ...
     ["Viele kennen Mietkauf nur vom Hörensagen. Was die meisten nicht wissen: Es gibt große Unterschiede — und unser Modell ist eines der käuferfreundlichsten, die es gibt.",
      "So funktioniert es: Sie leisten zu Beginn einen Grundanteil, der am Ende voll auf den Kaufpreis angerechnet wird. Sie ziehen ein und zahlen monatliche Miete. Der Kaufpreis wird heute vertraglich festgeschrieben — für 10 Jahre. Kein Zinsrisiko. Keine Preissteigerung. Keine bösen Überraschungen.",
