...
NUSSDORF = [
    (1, "Stellen Sie sich vor … ein Morgen am Attersee",
     ...
     ["Sie wachen morgens auf. Durch das Schlafzimmerfenster fällt der Blick über die Dächer von Nußdorf — und dahinter, glitzernd im frühen Licht, liegt der Attersee.",
    ...
    (2, "Der See gehört einfach dazu.",
     "Jeden Morgen dieser Ausblick – von Ihrer Terrasse, aus Ihrem Wohnzimmer, aus Ihrem Schlafzimmer.",
     "Freitag, Woche 1",
    ...
    (7, "Schlafen, wo andere träumen.",
     "Stellen Sie sich vor, wie es sich anfühlt, morgens aufzuwachen — mit Seeblick.",
     "Dienstag, Woche 4",
     "Der erste Blick am Morgen.",
     ["Es ist 7 Uhr. Sie öffnen die Augen. Durch die Schlafzimmerfenster fällt das erste Licht — und dahinter, in der Ferne, glitzert der See.",
      "Kein Wecker, der daran erinnert, dass das nur Urlaub ist. Kein Check-out. Kein Abreise-Gefühl.",
      "Die Seeblick Häuser sind so geplant, dass der Ausblick nicht nur im Wohnzimmer ankommt — sondern überall. In jedem Stockwerk. Aus jedem Zimmer.",
      "Ihr Schlafzimmer. Ihr Morgen. Jeden Tag."],
...
WEISSENKIRCHEN = [
    ...
    (2, "Mieten oder kaufen? Beides geht.",
     "Mietkauf: Erst einziehen, dann entscheiden — mit Sicherheit von Anfang an.",
     "Freitag, Woche 1",
     "Der dritte Weg: Mietkauf.",
     ["\"Wir würden gerne kaufen — aber der Zeitpunkt ist noch nicht ideal.\" Das hören wir oft. Und genau dafür haben wir eine Lösung.",
      "Mietkauf bedeutet: Sie ziehen ein wie bei einer Miete — aber mit der Option, das Haus zu einem vereinbarten Festpreis zu kaufen. Ihre Mietzahlungen werden dabei (teilweise) angerechnet.",
      "Kein Druck. Keine Entscheidung unter Zeitnot. Sie lernen das Haus kennen — und entscheiden dann.",
      "Ob Miete, Mietkauf oder Direktkauf: Wir finden das Modell, das zu Ihnen passt."],
     "fassade.jpg", "Reihenhäuser Weißenkirchen",
     "wohnzimmer3.jpg", "Heller Wohnbereich", "Flexibel einziehen — sicher wohnen."),
    ...
    (10, "Festpreis ist Festpreis.",
     "Was im Vertrag steht, ist was Sie zahlen — keine Überraschungen.",
     "Freitag, Woche 5",
     "Sicherheit hat einen Preis. Und der steht fest.",
     ["Beim Bauen oder Kaufen hört man oft: \"Das kommt noch dazu.\" Ein schleichendes Wachstum, das die ursprüngliche Kalkulation aus dem Gleichgewicht bringt.",
      "Bei den Reihenhäusern Weißenkirchen ist das anders. Wir arbeiten mit Festpreisgarantie — was im Vertrag steht, ist was Sie zahlen.",
      "Keine Nachforderungen, keine Überraschungen, kein Kleingedrucktes. Ein Preis. Ein Haus. Ein gutes Gefühl.",
      "Fragen Sie uns nach den genauen Konditionen — wir erklären alles transparent."],
     "fassade.jpg", "Reihenhäuser Weißenkirchen Fassade",
     "wohnzimmer3.jpg", "Heller Wohnbereich", "Festpreis — transparent und verlässlich."),
    ...
    (12, "Der Mietkauf im Detail.",
     "Wie funktioniert Mietkauf — und ist er das Richtige für Sie?",
     "Freitag, Woche 6",
     "Mietkauf erklärt.",
     ["Wir bekommen viele Fragen zum Mietkauf — und das ist gut. Weil er ein unbekanntes, aber sehr sinnvolles Modell ist.",
      "Kurz erklärt: Sie mieten das Haus zu einem vereinbarten monatlichen Betrag. Sie haben eine Kaufoption zu einem festgelegten Preis. Ein Teil Ihrer Miete wird auf den Kaufpreis angerechnet.",
      "Das gibt Ihnen Zeit — um die Finanzierung zu optimieren, eine Eigenkapitalreserve aufzubauen, oder einfach sicher zu sein.",
      "Interessiert? Wir erklären alles in einem persönlichen Gespräch — unverbindlich und in aller Ruhe."],
     "garderobe.jpg", "Eingangsbereich Reihenhäuser",
     "fassade.jpg", "Außenansicht Reihenhäuser Weißenkirchen", "Mietkauf — Ihr Weg ins Eigenheim."),
    ...
    (18, "Miete oder Mietkauf — was passt zu Ihnen?",
     "Wir helfen Ihnen, das Modell zu finden, das wirklich zu Ihrer Situation passt.",
     "Freitag, Woche 9",
     "Wir rechnen mit Ihnen.",
     ["Jeder Mensch hat eine andere finanzielle Situation. Manche können und wollen direkt kaufen. Andere brauchen mehr Zeit oder Flexibilität.",
      "Genau deshalb bieten wir verschiedene Modelle an: Direktkauf zum Festpreis, Mietkauf mit Kaufoption, klassische Miete.",
      "In einem kurzen Gespräch finden wir gemeinsam heraus, was für Sie am besten passt — ohne Druck, ohne Vorwegnahme.",
      "Soll ich Ihnen einfach mal die Zahlen zeigen? Unverbindlich?"],
     "wohnzimmer3.jpg", "Wohnzimmer Reihenhäuser",
     "kueche-vis.jpg", "Moderne Küche", "Ihr Weg — Ihr Modell."),
    ...
    (21, "Sommer 2026 ist näher als gedacht.",
     "Wer jetzt entscheidet, zieht noch dieses Jahr ein.",
     "Dienstag, Woche 11",
     "Der Countdown läuft.",
     ["Sommer 2026. Klingt noch fern — ist es aber nicht.",
      "Wer heute die Entscheidung trifft, kann noch im Sommer 2026 einziehen. Den ersten Abend im eigenen Garten verbringen. Die Kinder das erste Mal draußen spielen sehen.",
      "Wer noch wartet, schaut vielleicht auf den Herbst — oder noch weiter.",
      "Was hindert Sie noch?"],
     "fassade.jpg", "Reihenhäuser Weißenkirchen",
     "droneumgebung.jpg", "Weißenkirchen Umgebung", "Ihr Einzug — früher als Sie denken."),
