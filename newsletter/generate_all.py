...
WEISSENKIRCHEN = [
    ...
    (22, "Die ersten Familien sind schon dabei.",
     "In Weißenkirchen tut sich etwas — die ersten Häuser haben ihre Familien gefunden.",
     "Freitag, Woche 11",
     "Es geht los.",
     ["In Weißenkirchen tut sich etwas: Die ersten Familien haben sich bereits für ihr neues Zuhause entschieden.",
      "Wir freuen uns für sie — und auf alle weiteren, die diesen Schritt gehen.",
      "Noch sind Häuser verfügbar — aber sie finden nach und nach ihre Menschen. Vielleicht ist eines davon für Sie.",
